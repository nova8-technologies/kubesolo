...
var (
	...
	Manifests              = Application.Flag("manifests", "Newline-separated list of manifest URLs or local file paths to apply after API server is ready.").Envar("KUBESOLO_MANIFESTS").Default("").String()
